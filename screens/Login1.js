...
//validation
    const validate_field = () => {
        ...
        if(data.username == "" || data.password == ""){
            return(Alert.alert("Invalid Attempt","Please login with Valid Credentials."))
        ...
        if (!/\S+@\S+\.\S+/.test(data.username)) {
            return(Alert.alert("Invalid Credentials","Please provide a valid E-mail."))
        }
...
//logo animation
    ...
    return (
        ...
        <View style={styles.inputContainer}>
            ...
            <Animatable.View animation="fadeInLeft" duration={500}>
            <Text style={styles.errorMsg}>Password must be 6-8 characters long.</Text>
            </Animatable.View>
            }
